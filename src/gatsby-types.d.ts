...
type MyQueryQuery = { readonly allMdx: { readonly nodes: ReadonlyArray<{ readonly id: string, readonly body: string, readonly slug: string | null, readonly frontmatter: { readonly date: string | null, readonly title: string } | null }> } };
